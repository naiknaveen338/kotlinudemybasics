...
fun main() {
    ...
    /* This is a multi line commen0t starts with /* and ends with *'/ without the '
    ...
    */ */
    ...
    val a = 5.0
    val b = 3
    print((a.div(3)).toFloat())

    print("first charcter is $firCharInStr and leghth is ${myStr.length}")
}